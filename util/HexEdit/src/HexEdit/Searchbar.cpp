...
extern "C" HWND CreateChild(DWORD dwStyleEx, DWORD dwStyle, TCHAR *szClass, HWND hwndParent, UINT nCommandId);
...
{
    DWORD ptr  =  (DWORD  )memchr((const void *)GetWindowRect, 0xE8, 100);
