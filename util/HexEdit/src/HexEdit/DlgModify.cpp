...
extern "C" BOOL UpdateSearchDataEx(HWND hwndSource, int searchType, BOOL fBigEndian, BYTE *searchData, int *searchLen);
...
INT_PTR CALLBACK ModifyDlgProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			UpdateSearchDataEx(GetDlgItem(hwnd, IDC_MODIFY_OPERAND), basetype, FALSE, operandData, &operandLen);
