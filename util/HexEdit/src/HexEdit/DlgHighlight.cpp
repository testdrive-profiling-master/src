...
BOOL GetConfigBookmark(HCONFIG hBookmark, BOOKMARK *bm)
{
	...
	GetConfigH32(hBookmark, TEXT("fgcol"), (UINT32*)&bm->col, 0);
	GetConfigH32(hBookmark, TEXT("bgcol"), (UINT32*)&bm->backcol, 0);
...
BOOL SaveHighlights(HWND hwndHexView)
{
	...
	if(!GetBookmarkFileName(hwndHexView, NULL, szBookPath)) return FALSE;
