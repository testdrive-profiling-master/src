...
#define HVM_SHOWPHYSICAL	(HVM_FIRST + 67)
#define HVM_RETRIEVE_ADDRESS	(HVM_FIRST + 68)
#define HVM_REFRESH			(HVM_FIRST + 69)
...
#define HexView_ShowPhysical(hwnd, bEnable) \
	(UINT)SNDMSG((hwnd), HVM_SHOWPHYSICAL, (WPARAM)(bEnable), 0)
...
#define HexView_Refresh(hwnd) \
	(UINT)SNDMSG((hwnd), HVM_REFRESH, 0, 0)
/**
...
#define HexView_IsMMAP(hwnd) \
	(BOOL)SNDMSG((hwnd), HVM_ISMMAP, 0, 0)
...
#define HexView_RetrieveAddress(hwnd, address) \
	(VOID)SNDMSG((hwnd), HVM_RETRIEVE_ADDRESS, (WPARAM)((UINT64*)address), 0)
