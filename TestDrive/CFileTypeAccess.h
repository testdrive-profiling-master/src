...
//- -----------------------------------------------------------------
// reference http://www.codeproject.com/Articles/621/Associate-File-Extension-with-Shell-OPEN-command-a
...
#define __FILE_TYPE_ACCESS_H__

class CFileTypeAccess
{
public:
